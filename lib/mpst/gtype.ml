...
module Formatting = struct
  ...
  let rec pp ppf = function
    | MessageG (m, r1, r2, g) ->
        ...
        pp ppf g
    | MessageGT (m, r1, r2, g, clock, time_const, reset_clock) ->
        pp_print_string ppf (show_message m) ;
        pp_print_string ppf " from " ;
        pp_print_string ppf (RoleName.user r1) ;
        pp_print_string ppf " to " ;
        ...
        pp_print_string ppf (TimeConst time_const) ;
        pp_print_string ppf " using " ;
        pp_print_string ppf (ClockName clock) ;
        pp_print_string ppf " resetting " ;
        pp_print_string ppf (ResetClock reset_clock) ;
        pp_print_string ppf ";" ;
        pp_force_newline ppf () ;
        pp ppf g
    | MuG (n, rec_vars, g) ->
